...
/**
 * Action to list items that are recently used by the user
 * 
 * @author yucca.io
 */
public class RecentAction extends AbstractAction
    ...
    private static final Logger LOG = LoggerFactory
        .getLogger(RecentAction.class);

    public static final String ACTION = "view.recent";
     ...
     */
    public RecentAction(OneDriveAPIConnection api) {
        super(api);
    }

    /**
     * Listing items recently used by user
     * 
     * @return ItemIterable
     */
    @Override
