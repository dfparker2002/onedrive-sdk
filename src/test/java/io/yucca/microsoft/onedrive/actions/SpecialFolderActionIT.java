...
public class SpecialFolderActionIT extends AbstractActionIT {

    @Test
    public void testGetSpecialFolder() {
        SpecialFolderAction action = new SpecialFolderAction(api,
                                                             SpecialFolder.DOCUMENTS);
        assertNotNull(action.call());
    }

    @Test
    public void testGetSpecialFolderChildren() {
